<template>
    <div class="main-rectangle">
        ...
        <div class="my-fat-button" style="display: flex; justify-content: center; align-items: center;">
            <my-fat-button
                style="margin-top: 5px; margin-bottom: 10px; margin-left: 10px; margin-right: 10px; width: 383px; height: 173px;">
                <span style=" display: flex; align-items: center;
...
.webcam-window {
    ...
    border-radius: 25px;
    overflow: hidden;
    /* Это чтоб блок внутри занимал полностью родительский div  */
}
